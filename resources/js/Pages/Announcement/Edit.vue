...
export default {
  ...
  setup() {
    const form = useForm({
      title: usePage().props.value.announcement.title,
      content: usePage().props.value.announcement.content,
      startDate: usePage().props.value.announcement.startDate,
      endDate: usePage().props.value.announcement.endDate,
    ...
    const submit = () => {
      form.put(route('announcements.update', usePage().props.value.announcement.id), {
        onSuccess: () => {
          form.reset()
        },
      })
